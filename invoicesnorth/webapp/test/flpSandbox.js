		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#logaligroupinvoicesnorth-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupinvoicesnorth-display": {
								"semanticObject": "logaligroupinvoicesnorth",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.invoicesnorth",
									"url": sap.ui.require.toUrl("logaligroup/invoicesnorth")
								}
							}
						}
					}
